...
public class FileStorageRepositoryJdbcTemplateImpl implements FileStorageRepository {
    ...
    //language=SQL
    private final String SQL_INSERT_FILE_INFO = "INSERT INTO file_storage_info (storage_file_name, original_file_name, size, type, url, car_id) values (?, ?, ?, ?, ?, ?);";
    //language=SQL
    ...
    public void update(FileInfo model) {
        // TODO
        Object[] params = new Object[]{model.getStorageFileName(), model.getOriginalFileName(), model.getSize(), model.getType(), model.getUrl(), model.getCar().getId()};
    }
